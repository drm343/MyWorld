...
void EXPORT(free) (Game_Status_Access self);
   ...
   * @return 設定結果
  */
Execute_Result EXPORT(parse_npc_config) (Game_Status_Access self,
  ...
  */
Found_Result EXPORT(find_character) (Game_Status_Access self,
   ...
   * 根據方形的兩個點重新計算角色位置。
   */
void EXPORT(calculate_graph_position) (Game_Status_Access self,
   ...
   * 設定。
   */
Character_Access EXPORT(use_ally) (Game_Status_Access self,
   ...
   * 設定。
   */
Character_Access EXPORT(use_enemy) (Game_Status_Access self,
                                    const char *race, const char *name,
                                    Map_Access map);
   ...
   * 設定。
   */
Character_Access EXPORT(use_neutral) (Game_Status_Access self,
                                      const char *race, const char *name,
                                      Map_Access map);
...
Character_Access EXPORT(get_instance_by_index) (Game_Status * self,
   ...
   *  隨機移動
  */
Message_Type EXPORT(action) (Game_Status_Access self,
  ...
  */
Is_Alive EXPORT(attack_enemy_by) (Game_Status_Access self,
   ...
   * 直接呼叫 character.attack 不會改變 pool 內的立場，因此必須透過 pool 轉呼叫。
  */
Is_Alive EXPORT(attack_ally_by) (Game_Status_Access self,
                                 Character_Access current,
                                 Character_Access target);
   ...
   * 直接呼叫 character.attack 不會改變 pool 內的立場，因此必須透過 pool 轉呼叫。
  */
Is_Alive EXPORT(attack_neutral_by) (Game_Status_Access self,
                                    Character_Access current,
                                    Character_Access target);
   ...
   * @return 目標的生存狀況
  */
Is_Alive EXPORT(attack_player_by) (Game_Status_Access self,
                                   Character_Access current);
#undef EXPORT
#endif
