...
package My_World.Sub_Window is
   ...
   type Sub_Window_Type is tagged record
   ...
   procedure Clear (Sub_Window : in out Sub_Window_Type);
   procedure Box (Sub_Window : in out Sub_Window_Type);
   procedure Delete (Sub_Window : in out Sub_Window_Type);

   procedure Draw_Line (Sub_Window : in out Sub_Window_Type);
   procedure Draw_Line (Sub_Window : in out Sub_Window_Type; Column : Integer);

   procedure Draw_Column (Sub_Window : in out Sub_Window_Type);
   procedure Draw_Column (Sub_Window : in out Sub_Window_Type; Line : Integer);

   procedure Update (Sub_Window : in out Sub_Window_Type; Message : Character);
   ...
   procedure Update (Sub_Window : in out Sub_Window_Type; Message : String);
