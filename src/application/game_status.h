 ...
 * @param self 要使用的遊戲狀態
*/
void Game_Status_free(Game_Status_Access self);
...
*/
Execute_Result
Game_Status_parse_npc_config(Game_Status_Access self,
...
*/
Found_Result
Game_Status_find_character(Game_Status_Access self,
 ...
 */
void
Game_Status_calculate_graph_position(Game_Status_Access self,
                                     Rectangle rectangle);
 ...
 */
Character_Access
Game_Status_use_ally(Game_Status_Access self,
 ...
 */
Character_Access
Game_Status_use_enemy(Game_Status_Access self,
                      const char *race, const char *name, Map_Access map);
 ...
 */
Character_Access
Game_Status_use_neutral(Game_Status_Access self,
 ...
 */
Character_Access Game_Status_use_player(Game_Status_Access self);
...
*/
Message_Type
Game_Status_action(Game_Status_Access self,
...
*/
Is_Alive
Game_Status_attack_enemy_by(Game_Status_Access self,
...
*/
Is_Alive
Game_Status_attack_ally_by(Game_Status_Access self,
                           Character_Access current,
                           Character_Access target);
...
*/
Is_Alive
Game_Status_attack_neutral_by(Game_Status_Access self,
                              Character_Access current,
                              Character_Access target);
...
*/
Is_Alive
Game_Status_attack_player_by(Game_Status_Access self,
                             Character_Access current);
 ...
 * @return 下一個角色
*/
Character_Access Game_Status_next(Game_Status * self,
